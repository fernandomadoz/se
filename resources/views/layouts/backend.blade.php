      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
              <li><a href="<?php echo env('PATH_PUBLIC')?>list/Dato/0"><i class="fa fa-file-text-o"></i> Datos</a></li> 
              <li><a href="<?php echo env('PATH_PUBLIC')?>list/Horario/0"><i class="fa fa-file-text-o"></i> Horarios</a></li> 
              <li><a href="<?php echo env('PATH_PUBLIC')?>list/Usuario/0"><i class="fa fa-file-text-o"></i> Usuarios</a></li> 
          </ul>
        </li>
        <?php } ?>
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">     
              ...
              <li><a href="<?php echo env('PATH_PUBLIC')?>list/User/2"><i class="fa fa-key"></i> Users</a></li>  
          </ul>
        </li>
        <?php } ?>
